                            ...
                            <div className="dialog-content">
                                <div className="flex flex-col">
                                    <div className="flex justify-between">
                                        ...
                                        <Image src="/assets/icons/x-close.svg" alt="close" width={24} height={24}  className="cursor-pointer" onClick={closeModel}/>
                                    </div>
                                ...
                                <form className="flex flex-col mt-5" onSubmit={handleSubmit}>
                                    ...
                                    <div className="dialog-input_container">
                                        ...
                                        <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email address"  required className="dialog-input"/>
                                    </div>

                                    <button type="submit" className="dialog-btn">{ isSubmitting ? 'Submitting' : 'Track Product'}</button>
                                </form>
                            </div>
                        </Transition.Child>
                    </div>
